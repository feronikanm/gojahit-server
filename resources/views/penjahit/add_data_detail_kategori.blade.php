              ...
              <form method="post" action="/data_penjahit/show/kategori/store" class="form-horizontal">
                ...
                <div class="card-content ">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group label-floating is-empty">
                        ...
                        <input class="form-control" name="id_penjahit" id="category" type="hidden" value="{{ $data->id_penjahit  }}"  />
                      </div>
                    </div>
                  </div>  
                  ...
                  <div class="form-footer text-right">
                    <a type="button" class="btn btn-white pull-fill" href="/data_penjahit/show/{{ $data->id_penjahit }}">Kembali</a>
