        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="/data_penjahit/show/kategori/update/{{ $data->id_detail_kategori }}" class="form-horizontal">
                      {{ csrf_field() }}
                        ...
                        {{-- <div class="row">
                          ...
                          <div class="col-sm-7">
                              <div class="form-group label-floating is-empty">
                                ...
                                <input class="form-control" name="id_kategori" id="category" type="hidden" value="{{ $data->tbl_penjahit->nama_penjahit  }}"  />
                              </div>
                          </div>
                      </div> --}}
                    ...
                    <div class="form-footer text-right">
                      <a type="button" class="btn btn-white pull-fill" href="/data_penjahit/show/{{ $data->tbl_penjahit->id_penjahit }}">Kembali</a>
