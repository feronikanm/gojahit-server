...
@section('page_name', 'Edit Data Pesanan')
        ...
        <div class="col-md-8">
          <div class="card">
            ...
            <div class="card-header card-header-tabs" data-background-color="purple">
              <h4 class="card-title ">Edit Data Pesanan</h4>
            </div>
                  
            <div class="card-body">

              <form method="post" action="/data_pesanan/update/{{ $data->id_pesanan }}" enctype="multipart/form-data" class="form-horizontal">
                {{ csrf_field() }}
                ...
                <div class="card-content ">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group label-floating is-empty">
                        <textarea class="form-control" rows="3" name="catatan_pesanan" placeholder="{{ __('Catatan tambahan') }}" value="{{ $data->catatan_pesanan }}"></textarea>                                  
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group label-floating is-empty">
                        <input class="form-control" name="harga_bahan" id="category" type="number" placeholder="{{ __('1') }}" value="{{ $data->panjang_bahan }}"  />                                  
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group label-floating is-empty">
                        <input class="form-control" name="harga_bahan" id="category" type="number" placeholder="{{ __('1') }}" value="{{ $data->lebar_bahan }}"  />                                  
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      <div class="form-group label-floating is-empty">
                        <input class="form-control" name="jumlah_jahitan" id="category" type="number" placeholder="{{ __('Contoh : 1') }}" value="{{ $data->jumlah_jahitan }}" />                                  
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      <div class="form-group label-floating is-empty">
                        <input class="form-control" name="status_pesanan" id="category" type="text"  value="{{ $data->jumlah_jahitan }}" />                                  
                      </div>
                    </div>
                  </div>

                  <div class="form-footer text-right">
                    <a type="button" class="btn btn-white pull-fill" href="/data_pesanan">Kembali</a>
                    <button type="submit" onclick="return confirm('Ingin mwngubah data?')" class="btn btn-primary pull-fill">Simpan</button>
                  </div>     
